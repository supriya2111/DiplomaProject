...
<body data-spy="scroll" data-target=".site-navbar-target"
	...
	<%
		...
		String enroll_no=session.getAttribute("enroll_no").toString(); 
	%>
		...
		<div class="container">
			<div class="row justify-content-center pb-5">
				<div class="col-md-10 heading-section text-center ftco-animate">
					...
					<h2 class="mb-4">Attend Practical</h2>
					<div align="center">
						<form action="ViewPractical.jsp" method="post">
							<table border="1">
								<tr>
									<td align="center">Enrollment No:-</td>
									<td><input type="text" name="entroll_no" value="<%=enroll_no %>" required /></td>
								</tr>	
								<tr>
