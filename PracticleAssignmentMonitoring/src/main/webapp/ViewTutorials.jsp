		...
		<div class="container">
			<div class="row justify-content-center pb-5">
				<div class="col-md-10 heading-section text-center ftco-animate">
					...
					<div align="center">
						<form action="ViewTutorialData.jsp" method="post">
							...
							<table border="1">
								...
								if(request.getParameter("subject")!=null)
								{
									...
									<td><input type="text" value="<%=subject%>" readonly="readonly"></td>
								</tr>
									<tr>
			...
			<%
								...
								PreparedStatement ps=con.prepareStatement("select * from c_practical_details");
								ResultSet rs=ps.executeQuery();
								while(rs.next())
								{
								%>
								
			<option value="<%=rs.getInt("id")%>"><%=rs.getString("assign_name") %></option>
