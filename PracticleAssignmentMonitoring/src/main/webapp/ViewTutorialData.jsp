		...
		<div class="container">
			<div class="row justify-content-center pb-5">
				<div class="col-md-10 heading-section text-center ftco-animate">
					...
					<h2 class="mb-4">View Tutorials</h2> 
					<div align="center"> 					 
			  <form action="ViewTutorials.jsp"> 
			<% 
								Connection con=DbConnection.getConnection();
								PreparedStatement ps=con.prepareStatement("select * from c_practical_details where id="+request.getParameter("aim"));
								...
								<tr>
								<td>
								<textarea rows="2" cols="40"><%=rs.getString("assign_name")%> </textarea>
								</td>
								</tr>
								</table>
								<table>
								<tr>
								<td><textarea rows="20" cols="80"><%=rs.getString("basic_info")%> </textarea></td>
								</tr>
								<tr align="center">
								<td><input type="hidden" name="subject" value="C"><input type="submit" value="Back"></td>
								</tr>
								</table>
								<%
								}	
