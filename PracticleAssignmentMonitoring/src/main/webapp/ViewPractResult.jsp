		...
		<div class="container">
			<div class="row justify-content-center pb-5">
				<div class="col-md-10 heading-section text-center ftco-animate">
					...
					<h2 class="mb-4">View Practical Result</h2> 
					<div align="center">
						 	<table border="1" style="width: 60%">
								...
								<tr align="center">
									...
									<td><%=rs.getString("task1") %></td> 
									<td><%=rs.getString("task2") %></td> 
									<td><%=rs.getString("task3") %></td> 
									<td><%=rs.getString("task4") %></td> 
									<td><%=rs.getString("task5") %></td> 
								</tr>										
									<%
								}
								%> 
